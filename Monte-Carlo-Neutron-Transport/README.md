...
## ​📖 Where it Came From​
The inspiration for this project stems from reading **Richard Rhodes’** ***The Making of the Atomic Bomb***.​Rhodes meticulously details the transition from theoretical
...
​**High-Performance C++:** Managing memory and execution speed as particle counts grow exponentially. - 

​**Nuclear Physics Fundamentals:** Understanding the relationship between density, cross-section (\sigma), and the "critical mass" required for a sustained reaction.
